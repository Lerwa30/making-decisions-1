...
if(temperature >= 80 && rain === true){
  ...
  console.log("Wear a t-shirt and leave the umbrella at home")
} else if(temperature > 60 && temperature < 80 && rain === false){
  console.log("Wear a sweater with no umbrella")
} else if(temperature <= 60 && rain === false){
  console.log("Wear a jacket and leave the umbrella at home")
} 
//CODE HERE
...
//needed to peek at solution but I believe i understand why it runs this way
//CODE HERE
